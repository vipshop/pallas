...
/**
 * Purpose of this class is to make getParameter() return post data AND also be able to get entire body-string. In
 * native implementation any of those two works, but not both together.
 */
