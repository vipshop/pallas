...
public interface ApproveRepository {
    ...
    List<Approve> selectApplyPage(Page<Approve> page);

    List<Approve> selectApprovePage(Page<Approve> page);

    int getCountByTemplateIdAndState(Long templateId, Integer state);
}