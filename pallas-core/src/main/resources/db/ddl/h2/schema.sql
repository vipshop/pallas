...
CREATE TABLE IF NOT EXISTS `approve` (
  ...
  `apply_user` varchar(256)  NOT NULL DEFAULT '' COMMENT '申请人',
  `apply_time` timestamp NOT NULL DEFAULT '1980-01-01 01:01:01' COMMENT '申请时间',
  `approve_user` varchar(256)  NOT NULL DEFAULT '' COMMENT '审批人',
  `approve_time` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT '审批时间',
  `approve_opinion` varchar(256)  NOT NULL DEFAULT '' COMMENT '审批意见',
...
CREATE TABLE IF NOT EXISTS `authorization` (
  `id` bigint(15) unsigned NOT NULL AUTO_INCREMENT COMMENT '自增ID',
  `client_token` varchar(255)  NOT NULL DEFAULT '' COMMENT 'Client-Token 值',
  `title` varchar(255)  NOT NULL DEFAULT '' COMMENT '备注',
  `authorization_items` varchar(20000)  NOT NULL DEFAULT '[]' COMMENT '权限配置组合',
...
CREATE TABLE IF NOT EXISTS `cluster` (
  ...
  `http_address` varchar(512)  DEFAULT NULL COMMENT 'HTTP地址',
  `client_address` varchar(512)  DEFAULT NULL COMMENT 'CLIENT地址',
  `create_time` timestamp NOT NULL DEFAULT '1980-01-01 01:01:01' COMMENT '创建时间',
  `update_time` timestamp NOT NULL DEFAULT '1980-01-01 01:01:01' COMMENT '更新时间',
  `is_deleted` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否己删除',
...
CREATE TABLE IF NOT EXISTS `data_source` (
  ...
  `dbname` varchar(128)  DEFAULT NULL COMMENT '表名',
...
CREATE TABLE IF NOT EXISTS `flow_record_config` (
  ...
  `note` varchar(256)  DEFAULT '' COMMENT '备注',
  `create_user` varchar(256)  NOT NULL DEFAULT '' COMMENT '提交人',
  `create_time` timestamp NOT NULL DEFAULT '1980-01-01 01:01:01' COMMENT '创建时间',
  `update_time` timestamp NOT NULL DEFAULT '1980-01-01 01:01:01' COMMENT '更新时间',
  `is_deleted` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否己删除，0:未删除；1:已删除',
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `index` (
  ...
  `index_name` varchar(128)  DEFAULT NULL COMMENT '索引名称（唯一）',
  `description` text  COMMENT '索引描述',
  `cluster_name` varchar(128)  DEFAULT NULL COMMENT '所属集群',
  `stat` varchar(64)  DEFAULT NULL COMMENT '索引状态(active:己启用，inactive:未启用)',
  `create_time` timestamp NOT NULL DEFAULT '1980-01-01 01:01:01' COMMENT '创建时间',
  `update_time` timestamp NOT NULL DEFAULT '1980-01-01 01:01:01' COMMENT '最后更新时间',
...
CREATE TABLE IF NOT EXISTS `index_routing` (
  ...
  `index_name` varchar(255)  NOT NULL DEFAULT '' COMMENT '索引逻辑名',
  `type` varchar(45)  NOT NULL DEFAULT 'index' COMMENT '路由所属类型，index是索引级别路由的节点集，cluster是集群路由级别的节点集',
  `routings_info` varchar(20000) NOT NULL DEFAULT '' COMMENT '路由信息',
  `create_time` timestamp NOT NULL DEFAULT '1980-01-01 01:01:01' COMMENT '创建时间',
  `update_time` timestamp NOT NULL DEFAULT '1980-01-01 01:01:01' COMMENT '更新时间',
  `is_deleted` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否己删除，0:未删除；1:已删除',
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `index_routing_security` (
  ...
  `index_id` bigint(15) NOT NULL DEFAULT '0' COMMENT '索引ID',
  `index_name` varchar(255)  NOT NULL DEFAULT '' COMMENT '索引逻辑名',
  `criteria` varchar(10000)  NOT NULL DEFAULT '' COMMENT '路由协议应用的限制条件',
  `protocol_controls` varchar(10000)  NOT NULL DEFAULT '' COMMENT '路由协议具体配置',
...
CREATE TABLE IF NOT EXISTS `index_routing_target_group` (
  ...
  `index_id` bigint(15) NOT NULL DEFAULT '0',
  `index_name` varchar(255)  NOT NULL DEFAULT '' COMMENT '索引逻辑名',
  `type` varchar(45)  NOT NULL DEFAULT 'index' COMMENT '节点集所属类型，index是索引级别路由的节点集，cluster是集群路由级别的节点集',
  `name` varchar(255)  NOT NULL DEFAULT '' COMMENT 'Target Group 名字',
  `nodes_info` varchar(10000)  NOT NULL DEFAULT '' COMMENT '选择集群信息',
  `clusters_info` varchar(10000)  NOT NULL DEFAULT '' COMMENT '选择集群信息',
  `state` int(11) NOT NULL DEFAULT '0' COMMENT '状态',
...
CREATE TABLE IF NOT EXISTS `index_version` (
  ...
  `index_id` bigint(15) DEFAULT NULL,
  `version_name` varchar(256)  DEFAULT NULL COMMENT '版本标识，随机生成（不可重复）',
  `is_used` tinyint(1) DEFAULT NULL COMMENT '是否启用（1：启用，0：未启用）',
  `sync_stat` varchar(30)  DEFAULT NULL COMMENT '同步状态(full_sync:全量；delta_sync:增量)',
  `num_of_shards` tinyint(3) DEFAULT NULL COMMENT '分片数量',
  `num_of_replication` tinyint(3) DEFAULT NULL COMMENT '复制数量',
  `vdp_queue` tinytext COMMENT 'vdp queue',
  `routing_key` varchar(256)  DEFAULT NULL COMMENT 'routing key',
  `create_time` timestamp NOT NULL DEFAULT '1980-01-01 01:01:01' COMMENT '创建时间',
  `update_time` timestamp NOT NULL DEFAULT '1980-01-01 01:01:01' COMMENT '更新时间',
  `id_field` varchar(256)  DEFAULT NULL COMMENT 'ID字段',
  `update_time_field` varchar(256)  DEFAULT NULL COMMENT 'update_time字段',
  ...
  `prefer_executor` varchar(256)  NOT NULL DEFAULT '' COMMENT '优先executor',
  `check_sum` tinyint(1) NOT NULL DEFAULT '0' COMMENT '遍历db前是否先检查条数',
  `real_cluster_id` bigint(15) NOT NULL DEFAULT '0' COMMENT '所属ES集群ID',
  `allocation_nodes` varchar(1024)  NOT NULL DEFAULT '' COMMENT '该索引版本创建在集群的哪些机器',
...
CREATE TABLE IF NOT EXISTS `mapping` (
  ...
  `field_name` varchar(256)  DEFAULT NULL COMMENT '字段',
  `field_type` varchar(256)  DEFAULT NULL COMMENT '索引类型',
...
CREATE TABLE IF NOT EXISTS `plugin_command` (
  ...
  `node_ip` varchar(255)  NOT NULL DEFAULT '' COMMENT '节点IP',
  `plugin_name` varchar(255)  NOT NULL DEFAULT '' COMMENT '插件名字',
...
CREATE TABLE IF NOT EXISTS `plugin_runtime` (
  ...
  `plugin_name` varchar(255)  NOT NULL DEFAULT '' COMMENT '插件名字',
  `plugin_version` varchar(255)  NOT NULL DEFAULT '' COMMENT '插件版本',
  ...
  `es_version` varchar(50)  NOT NULL DEFAULT '' COMMENT 'ES版本号',
  `note` varchar(1000)  NOT NULL DEFAULT '' COMMENT '备注',
  `create_time` timestamp NOT NULL DEFAULT '1980-01-01 01:01:01' COMMENT '创建时间',
  `update_time` timestamp NOT NULL DEFAULT '1980-01-01 01:01:01' COMMENT '更新时间',
  `is_deleted` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否己删除',
...
CREATE TABLE IF NOT EXISTS `plugin_upgrade` (
  ...
  `package_path` varchar(512)  NOT NULL DEFAULT '' COMMENT '插件包存储路径（VOS）',
  ...
  `approve_user` varchar(255)  NOT NULL DEFAULT '' COMMENT '审批人',
  `approve_time` timestamp NULL DEFAULT NULL COMMENT '审批时间',
  `create_time` timestamp NOT NULL DEFAULT '1980-01-01 01:01:01' COMMENT '创建时间',
  `update_time` timestamp NOT NULL DEFAULT '1980-01-01 01:01:01' COMMENT '更新时间',
  `flowlsh_no` varchar(255) DEFAULT NULL COMMENT '审批流程工单号',
  `flowlsh_state` tinyint(2) NOT NULL DEFAULT '3' COMMENT '0:init；1:created；2:start；3:end',
  `grey_ips` varchar(4096) NOT NULL DEFAULT '' COMMENT '正在灰度的插件ip列表',
...
CREATE TABLE IF NOT EXISTS `search_server` (
  ...
  `pools` varchar(255) NOT NULL DEFAULT '[]' COMMENT '节点集',
  ...
  `is_deleted` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否己删除，0:未删除；1:已删除',
  `take_traffic` tinyint(1) NOT NULL DEFAULT '1' COMMENT 'traffic',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 ;
...
CREATE TABLE IF NOT EXISTS `search_template` (
  `id` bigint(15) unsigned NOT NULL AUTO_INCREMENT COMMENT '自增ID',
  `index_id` bigint(15) DEFAULT NULL,
  `template_name` varchar(64)  DEFAULT NULL COMMENT '模板名',
...
CREATE TABLE IF NOT EXISTS `search_template_h` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id_unique_search_template_h` (`id`),
