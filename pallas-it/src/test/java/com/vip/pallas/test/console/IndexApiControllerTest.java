...
public class IndexApiControllerTest extends BaseSpringEsTest {
    ...
    @Test
    public void test2TemplateRetry() throws Exception {
        ResultVO<List> resultVO =  callGetApi("/template/retrytimeout_configured.json", List.class);
        assertThat(resultVO.getStatus()).isEqualTo(HttpStatus.OK.value());
    }
}