...
var connectTo = function(url,cluster, refreshInterval, storeSize, dispatcher, selectedView, callback) {

    var connectionConfig = { baseUrl: url, cluster: cluster};
...
//            console.log(description, data);
        ...
        button.click(function(){
            if (isConnected()) {
                ...
                connectTo(restEndPoint.val(), clusterNameDom.val(), getRefreshInterval(), getStoreSize(), bigdeskEventDispatcher, selectedView, switchButtonText);
            }
        });
        ...
        var parseUrlParams = function() {
            return {
                cluster: getSearchUrlVar("cluster") || "update_me_later",
        ...
        var applyUrlParams = function() {
            ...
            clusterNameDom.val(params.cluster);
